 ...
 */
export function shouldTargetUser(username: string, targetUsersConfig: string): boolean {
...
export async function validateTwitterConfig(
  ...
  try {
    ...
    const validatedConfig: TwitterConfig = {
      ...
      TWITTER_POST_ENABLE: String(getConfig('TWITTER_POST_ENABLE')?.toLowerCase() === 'true'),
      TWITTER_POST_INTERVAL_MIN: String(safeParseInt(getConfig('TWITTER_POST_INTERVAL_MIN'), 90)),
      TWITTER_POST_INTERVAL_MAX: String(safeParseInt(getConfig('TWITTER_POST_INTERVAL_MAX'), 180)),
      ...
      TWITTER_TIMELINE_ALGORITHM: (getConfig('TWITTER_TIMELINE_ALGORITHM') === 'latest'
        ? 'latest'
      ...
      TWITTER_MAX_TWEET_LENGTH: String(safeParseInt(getConfig('TWITTER_MAX_TWEET_LENGTH'), 4000)),
      ...
      TWITTER_ACTION_INTERVAL: String(safeParseInt(getConfig('TWITTER_ACTION_INTERVAL'), 240)),
