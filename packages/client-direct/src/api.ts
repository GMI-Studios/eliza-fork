...
import { type AgentRuntime, elizaLogger, getEnvVariable, type UUID, validateCharacterConfig, type Character } from "@elizaos/core"
...
export function createApiRouter(agents: Map<string, IAgentRuntime>, directClient: DirectClient): Router {
  ...
  router.post("/twitter/handle", async (req, res) => {
